...
<body>
				...
				<%}%>
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item active"><a class="nav-link" href="http://localhost:8080/Club10Sports/Contact.jsp">Contact</a></li>
	...
	<section class="contact_area section_gap_bottom">
		<div class="container">
			<div id="mapBox" class="mapBox" data-lat="12.972442" data-lon="77.580643" data-zoom="13" data-info="kristu jayanti,kothanur, Bangalore, India."
			 data-mlat="12.972442" data-mlon="77.580643">
			</div>
				...
				<div class="col-lg-3">
					<div class="contact_info">
						<div class="info_item">
							...
							<h6>Bangaluru , India</h6>
							<p>Knarayanapura main road, kothanur</p>
						</div>
				...
				<div class="col-lg-3">
					<div class="contact_info">
						...
						<div class="info_item">
							...
							<h6><a href="#">Club10Sports@gmail.com</a></h6>
